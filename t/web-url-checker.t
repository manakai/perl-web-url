...
my $Cases = [
  ...
  {
    data => q<%a2>,
    errors => ['w:0.3:URL:lowercase hexadecimal digit'],
  },
  {
    data => q<%a2?>,
    errors => ['w:0.3:URL:lowercase hexadecimal digit'],
  ...
  {
    data => q<?%a2>,
    errors => ['w:1.4:URL:lowercase hexadecimal digit'],
  },
  {
    data => q<%a2%1b>,
    errors => ['w:0.3:URL:lowercase hexadecimal digit',
               'w:3.6:URL:lowercase hexadecimal digit'],
  },
  {
    data => q<http://%5b/>,
    errors => ['w:7.10:URL:lowercase hexadecimal digit',
               'w::URL:non-DNS host'],
  },
  {
    data => q<http://%5b/%25a/bv/%cc>,
    errors => ['w:7.10:URL:lowercase hexadecimal digit',
               'w:19.22:URL:lowercase hexadecimal digit',
               'w::URL:non-DNS host'],
  },
  {
    data => q<%41>,
    errors => ['w:0.3:URL:percent-encoded unreserved'],
  },
  {
    data => q<%41%7E>,
    errors => ['w:0.3:URL:percent-encoded unreserved',
               'w:3.6:URL:percent-encoded unreserved'],
  },
  {
    data => q</%41>,
    errors => ['w:1.4:URL:percent-encoded unreserved'],
  },
  {
    data => q<http://%5a/>,
    errors => ['w:7.10:URL:lowercase hexadecimal digit',
               'w:7.10:URL:percent-encoded unreserved'],
  },
  {
    data => q<./%2E%2E>,
    errors => ['w:2.5:URL:percent-encoded unreserved',
               'w:5.8:URL:percent-encoded unreserved'],
  },
  {
    data => q<http://www.example.com/%7Euser/>,
    errors => ['w:23.26:URL:percent-encoded unreserved'],
  },
  {
    data => q<HTTP://example/>,
  ...
  },
  {
    ...
    errors => ['m::syntax error:iriref3987',
               'w::URL:uppercase scheme name',
               'w:1.4:URL:percent-encoded unreserved'],
  },
  {
    data => q<g%7A:,>,
    errors => ['m::syntax error:iriref3987',
  ...
  {
    data => q<http://[v0.aaa]/>,
    errors => ['w:1.3:URL:address format:v0'],
  },
  {
  ...
  },
  {
    ...
    errors => ['w:1.4:URL:address format:V0A',
  ...
  {
    data => q<http://%61.test/>,
    errors => ['w:7.10:URL:percent-encoded unreserved'],
  },
  {
    data => q<http://a.test/>,
    errors => [],
  ...
  },
  {
    ...
    errors => ['w::URL:uppercase scheme name',
               'w:21.24:URL:percent-encoded unreserved',
               'w:25.28:URL:lowercase hexadecimal digit',
               'w:31.34:URL:lowercase hexadecimal digit',
               'w::URL:dot-segment'],
  },
  {
  ...
  },
  {
    ...
    errors => ['m::syntax error:iriref3987',
               'w:0.3:URL:percent-encoded unreserved',
               'w::URL:default port'],
  },
  {
    data => q<file://user@/>,
    errors => ['w:5.5:URL:empty host'],
  },
  {
    data => q<http://example.com/?>,
    errors => [],
  ...
  },
  {
    ...
    errors => ['w:31.34:URL:lowercase hexadecimal digit',
               'w:37.40:URL:lowercase hexadecimal digit'],
  },
  {
...
for my $test (@$Cases) {
  test {
    my $c = shift;
    my $checker = Web::URL::Checker->new_from_string ($test->{data});
    ...
    $checker->onerror (sub {
      ...
      push @errors, $opt{level} . ':' .
          (defined $opt{pos_start} ? $opt{pos_start} . '.' . $opt{pos_end} : '') . ':' . $opt{type} .
          (defined $opt{text} ? ':' . $opt{text} : '');
    });
    $checker->check_iri_reference;
    @errors = sort {$a cmp $b} @errors;

    eq_or_diff \@errors, $test->{errors};
    done $c;
  } n => 1, name => $test->{data};
} # $test
